...
geria --allow-overwrite=true --auto-file-renaming=true --bt-enable-lpd=true --bt-detach-seed-only=true \
...
tor-bit -d --profile="$(pwd)"
sabji -f sabnzbd/SABnzbd.ini -s :::8070 -b 0 -d -c -l 0 --console